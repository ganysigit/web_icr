...
//Koneksi ke Database
$conn = mysqli_connect("localhost", "root", "", "database_pendaftaran");
...
$sql = "INSERT INTO data_terdaftar (nama_anak, umur_anak, asal_sekolah, nama_orangtua, nohp_orangtua, centre_terdekat, paket_dipilih, hadiah_angpao)
